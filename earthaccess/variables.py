...
class DataVariables(VariableQuery):
    """A Service client for NASA CMR that returns data on collection variables.

    API: https://cmr.earthdata.nasa.gov/search/site/docs/search/api.html#variable
    """

    _format = "umm_json"

    def __init__(self, auth: Optional[Auth] = None, *args: Any, **kwargs: Any) -> None:
        """Build an instance of DataVariables to query CMR.
    ...
    def get(self, limit: int = 2000) -> List:
        """Get all variable results up to some limit.
